class BarangayFmrProjectsController < ApplicationController
  ...
  private
    ...
    def barangay_fmr_project_params
      params.require(:barangay_fmr_project).permit(:tag, :barangay_id, :name_of_fmr_project, :location, :fmr_project_typology_id, :project_length, :date_project_started, :date_project_ended, :date_completed, :project_status)
    end
end
