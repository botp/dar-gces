class BarangayBridgeProjectCompletionsController < ApplicationController
  ...
  private
    ...
    def barangay_bridge_project_completion_params
      params.require(:barangay_bridge_project_completion).permit(:barangay_bridge_project_id, :tag, :name, :description, :percentage_completion, :date_confirmed, :user_id, :datetime_edited)
    end
end
