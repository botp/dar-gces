class BarangayBridgeProjectsController < ApplicationController
  ...
  private
    ...
    def barangay_bridge_project_params
      params.require(:barangay_bridge_project).permit(:tag, :barangay_id, :name_of_bridge_project, :location, :type_of_project, :project_length, :project_length_provided, :date_project_started, :date_project_ended, :date_completed, :project_status, :bridge_project_typology_id)
    end
end
