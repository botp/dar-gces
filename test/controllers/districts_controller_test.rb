...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { description: @district.description, name: @district.name, province_id: @district.province_id }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { description: @district.description, name: @district.name, province_id: @district.province_id }
    assert_redirected_to district_path(assigns(:district))
  end
