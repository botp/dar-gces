...
class MunicipalitiesControllerTest < ActionController::TestCase
  ...
  test "should create municipality" do
    assert_difference('Municipality.count') do
      post :create, municipality: { description: @municipality.description, name: @municipality.name, tag: @municipality.tag }
    end
  ...
  test "should update municipality" do
    patch :update, id: @municipality, municipality: { description: @municipality.description, name: @municipality.name, tag: @municipality.tag }
    assert_redirected_to municipality_path(assigns(:municipality))
  end
