...
ActiveRecord::Schema.define(version: 20130912133638) do
  ...
  create_table "barangay_bridge_project_completions", force: true do |t|
    ...
    t.string   "name"
    t.text     "description"
    t.integer  "project_length_provided"
    t.date     "date_confirmed"
    t.integer  "user_id"
  ...
  create_table "barangay_irrigation_project_completions", force: true do |t|
  ...
  create_table "barangay_postharvest_structure_and_facility_projects", force: true do |t|
    t.integer  "barangay_id"
  ...
  create_table "postharvest_equipment_and_machinery_typologies", force: true do |t|
    t.string   "name"
    t.text     "description"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "postharvest_structure_and_facility_typologies", force: true do |t|
    t.string   "name"
    t.text     "description"
    t.datetime "created_at"
    t.datetime "updated_at"
